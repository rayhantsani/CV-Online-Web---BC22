 ...
 * @author kresna92
 */
@WebServlet(name = "SaveOrganizationServlet", urlPatterns = {"/SaveOrganizationServlet"})
public class SaveOrganizationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Organization o = new Organization(id, name, position, start, end, new Employee(empid));
            if (or.saveOrEdit(o)) {
