 ...
 * @author NINDA
 */
@WebServlet(name = "EditPEServlet", urlPatterns = {"/EditPEServlet"})
public class EditPEServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            session.setAttribute("detail", or.findById(new ProjectEmployee(), id));
