 ...
 * @author NINDA
 */
@WebServlet(name = "SaveTrainingServlet", urlPatterns = {"/SaveTrainingServlet"})
public class SaveTrainingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Training train = new Training(id, name, description, certificate, new Employee(employee));
            if (tController.saveOrEdit(train)) {
